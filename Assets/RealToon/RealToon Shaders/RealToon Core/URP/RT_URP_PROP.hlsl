...
#define _MinFadDistance								UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float, Metadata__MinFadDistance)
#define _MaxFadDistance								UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float, Metadata__MaxFadDistance)
